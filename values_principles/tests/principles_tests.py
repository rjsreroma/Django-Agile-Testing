...
class TestPrincipleCrud(TestCase):
    ...
    def test_principle_view_details(self):
        principle = Principle.objects.create(title='principle 1', description='this is principle')
    ...
    def test_principle_update(self):
        ...
        assert principle.title == 'principle updated', principle.description == 'description updated'

    def test_principle_delete(self):
        Principle.objects.create(title='principle 1', description='this is principle')
        Principle.objects.create(title='principle 2', description='this is another principle')
